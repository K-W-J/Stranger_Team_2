...
{
    public class FriendlyUnitAttackState : CombatUnitState
    {
        private float _currentTime = 0;
        private bool test = false;
        public FriendlyUnitAttackState(CombatUnit combatUnit, int animationHash) : base(combatUnit, animationHash)
        {
        }
